...
const DataCell = styled(TableCell)({
  ...
  height: 44, // Fixed height to match sidebar ListItem height
  boxSizing: 'border-box',
});
      ...
      <Box>
        ...
        <ContentRow>
          ...
          {barView === 'group' && leftOpen && (
            <LeftPanel>
              <LeftPanelHeader>
                <Typography variant="caption" style={{ color: '#fff', fontWeight: 600 }}>Groups</Typography>
                <Typography variant="caption" style={{ color: '#666' }}>(mock)</Typography>
              </LeftPanelHeader>
              <LeftPanelBody>
                ...
                {MOCK_GROUPS.map((group) => {
                  ...
                  return (
                    <React.Fragment key={group.id}>
                      {/* Sub-header row for group in table view if sidebar is hidden */}
                      {barView === 'list' && (
                         <TableRow style={{ backgroundColor: '#252525' }}>
                            <DataCell colSpan={headerColumns.length} style={{ fontWeight: 'bold', color: '#00b7ff' }}>
                      ...
                      {/* Spacer row when a group is collapsed to keep sidebar/table from getting out of sync */}
                      {!isOpen && barView === 'group' && (
