 ...
 */
type FilterProps = {
  /** Optional left-side header slot (e.g., view toggle icons). */
  headerLeft?: React.ReactNode;
  /** Optional right-side header slot (e.g., search + filter button). */
  headerRight?: React.ReactNode;
  /** If false, hides the inline top filters (Asset Name / Approval / Work). */
