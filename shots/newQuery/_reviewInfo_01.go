...
──────────────────────────────────────────────────────────────────────────
	...
	NOTE: count_reviews.sql groups by (project, root, group_1, relation) only,
	whereas ListReviewShots pages groups by (project, root, group_1, group_2,
	group_3, relation). If you need the count to line up exactly with the number
	of pageable groups, add group_2 / group_3 to the GROUP BY below.
