...
// Teal/cyan — distinct from all phase colors. Used for the CamDataType column.
const CAM_DATA_TYPE_COLORS: Colors = { lineColor: '#2DD4BF', backgroundColor: '#0F4D47' };
...
const buildColumns = (phaseComponents: { [key: string]: string[] }): Column[] => {
    ...
    // ← NEW: cam_data_type goes immediately before relation (the task's "to the left of Relation")
    return [
        ...fixed,
        ...phaseCols,
        { id: 'cam_data_type', label: 'CAMDATATYPE', colors: CAM_DATA_TYPE_COLORS },
    ...
    return (
        <TableCell
            ...
            style={{
                ...
                whiteSpace:      'nowrap',
                backgroundColor: isSelected ? 'rgba(0, 183, 255, 0.18)' : undefined,
    ...
    <TableHead>
        <TableRow>
            {columns.map((col) => {
                ...
                const wantsLeftBar = isAppr || col.id === 'cam_data_type';   // ← NEW
...
type ShotRowProps = {
    ...
    camDataTypes?:    { [shotKey: string]: string };   // ← NEW
...
const ShotRow: React.FC<ShotRowProps> = ({
    ...
    return (
        ...
        >
            ...
            {/* ← NEW: CamDataType — sits to the left of Relation */}
