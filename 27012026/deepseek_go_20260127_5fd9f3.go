/* ──────────────────────────────────────────────────────────────────────────
	...
	* - 27-01-2026 - Fixed grouping issues with proper TopGroupNode categorization.
...
`
	...
	// Step 2: Sort assets properly with grouping information
	sort.Slice(assets, func(i, j int) bool {
		// First sort by TopGroupNode (group headers)
		ti := strings.ToLower(assets[i].TopGroupNode)
		tj := strings.ToLower(assets[j].TopGroupNode)
