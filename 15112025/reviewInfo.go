func (r *ReviewInfo) ListLatestSubmissionsDynamic(
	...
	// phaseGuard controls how strongly we bias the *sort* towards preferredPhase.
	// (You can flip this logic if you want phase bias only when preferredPhase != "none".)
	phaseGuard := 0
	...
	// Status filter (no phase restriction – same keys as CountLatestSubmissions)
