...
// ---------------------------------------------------------------------
// Sorting helpers (sort items within each group)
// ---------------------------------------------------------------------
function getSortValue(asset: any, col: Column) {
  ...
  if (col.kind === "submitted") {
    return asset[phase + "_submitted_at_utc"] || asset[phase + "_submitted_at"] || null;
  }
...
function compareValues(a: any, b: any, dir: SortDir) {
  ...
  if (typeof a === "string" && typeof b === "string") {
    ...
    if (!Number.isNaN(at) && !Number.isNaN(bt)) return dir === "asc" ? at - bt : bt - at;
  }
        ...
        <Table size="small" stickyHeader className={classes.table}>
          ...
          <TableBody>
            {groups.map((group) => {
              ...
              const sortCol = visibleColumns.find((c) => c.id === sortKey);
              const sortedItems = sortCol && sortCol.sortable
                ? [...items].sort((a: any, b: any) => compareValues(getSortValue(a, sortCol), getSortValue(b, sortCol), sortDir))
                : items;
              return (
                <React.Fragment key={groupName}>
                  ...
                  {/* Data rows */}
                  {!isCollapsed && (sortedItems).map((asset: any, idx: number) => (
