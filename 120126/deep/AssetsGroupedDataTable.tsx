...
type Props = {
  ...
  onGroupSortChange?: (key: string) => void;
              ...
              return (
                <React.Fragment key={groupName}>
                  ...
                  <TableRow 
                    ...
                    onClick={() => {
                      toggle(groupName);
                      if (onGroupSortChange) onGroupSortChange('group_name');
                    }} 
                    ...
                    >
                      <Box display="flex" alignItems="center" justifyContent="space-between">
                        ...
                        <Box 
                          ...
                          onClick={(e) => {
                            e.stopPropagation();
                            if (onGroupSortChange) onGroupSortChange('group_count');
                          }}
                        >
                          <Typography style={{ fontSize: "0.75rem", fontWeight: 800, marginRight: 4 }}>
                            ({visibleCount} of {totalCount})
                          </Typography>
                          
                          {/* Group count sort indicator */}
                          {groupSortKey === 'group_count' && (
                            <Box display="flex" flexDirection="column" ml={0.5}>
                              <Box style={{ height: 4, fontSize: 8, color: groupSortDir === "asc" ? "#00b7ff" : "#555" }}>
                                ▲
                              </Box>
                              <Box style={{ height: 4, fontSize: 8, color: groupSortDir === "desc" ? "#00b7ff" : "#555" }}>
                                ▼
                              </Box>
                            </Box>
                          )}
