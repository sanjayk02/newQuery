...
class DataWidget(QWidget):
    ...
    def showCellContextMenu(self, view: QAbstractItemView, pos: QPoint) -> None:
        ...
        entity = self._entities.get(clickedGroup)
        ...
        historyAction.setEnabled(bool(clickedGroup and entityID))
        ...
        if selectedAction == editAction:
            ...
            self.showHistoryDialog(entityID, str(clickedGroup))

    def showHistoryDialog(self, entityID: str, entityName: str) -> None:
        dialog = HistoryDialog(self._api, entityID, entityName, parent=self)
        dialog.exec()
