...
const AssetsDataTablePanel: React.FC<RouteComponentProps> = () => {
  ...
  useEffect(() => {
    ...
    fetchLatestAssetComment(currentProject.key_name, undefined, controller.signal)
      .then((res) => {
        console.log('[AssetCommentCheck] latest comment response:', res);
      })
      .catch((err) => {
        if (err.name !== 'AbortError') {
          console.error('[AssetCommentCheck] failed:', err);
        }
      });
  ...
  // Now that 'groups' is declared, we can safely use it in useMemo
