...
const buildColumns = (phaseComponents: { [key: string]: string[] }): Column[] => {
    ...
    //  cam_data_type goes immediately before relation
    return [
        ...fixed,
        ...phaseCols,
...
const ShotDataRow: React.FC<{
...
}> = ({ shot, thumbnails, dateTimeFormat, columnsState, isLastRow, phaseComponents, latestComponents, camDataTypes, selectedCellIds, onCellSelect, selectedRowId, onRowSelect }) => {
    ...
    const getCellSel = (colId: string) => {
        ...
        const selBg = isCellSelected ? 'rgba(0, 183, 255, 0.18)' : undefined;
    ...
    return (
        <TableRow
            ...
            style={{
                backgroundColor: isRowSelected ? 'rgb(7, 192, 253)' : undefined,
        ...
        >
            ...
            <TableCell
                style={getStickyShotColumnStyle('group_1_name', { backgroundColor: isRowSelected ? 'rgb(7, 192, 253)' : '#3f3f3f' })}
            />

            {/* NAME 2 — empty, shown in group_2 header */}
            <TableCell
                style={getStickyShotColumnStyle('group_2_name', { backgroundColor: isRowSelected ? 'rgb(7, 192, 253)' : '#3f3f3f' })}
            />
...
const Group2HeaderRow: React.FC<{
    ...
    return (
        ...
        >
            <TableCell style={getStickyShotColumnStyle('thumbnail', { backgroundColor: 'rgba(255,255,255,0.04)' })} />
            <TableCell style={getStickyShotColumnStyle('group_1_name', { backgroundColor: 'rgba(255,255,255,0.04)' })} />

            {/* NAME 2 */}
            <TableCell style={{
                ...getStickyShotColumnStyle('group_2_name', { backgroundColor: 'rgba(255,255,255,0.04)' }),
                fontWeight: 500,
                color: '#ffffff',
                whiteSpace: 'nowrap',
                textAlign: 'center',
            ...
            <TableCell style={getStickyShotColumnStyle('group_3_name', { backgroundColor: 'rgba(255,255,255,0.04)' })} />
            ...
            {orderedPhases.map(phase => {
                ...
                return (
                    <React.Fragment key={phase}>
                        ...
                        {columnsState[`${colBase}_assign_to`] !== false && <TableCell />}
            ...
            {/* empty cell for CamDataType column alignment (teal left line) */}
...
const Group1HeaderRow: React.FC<{
    ...
    return (
        ...
        >
            <TableCell style={getStickyShotColumnStyle('thumbnail', { backgroundColor: 'rgba(255,255,255,0.07)' })} />

            {/* NAME 1 */}
            <TableCell style={{
                ...getStickyShotColumnStyle('group_1_name', { backgroundColor: 'rgba(255,255,255,0.07)' }),
                fontWeight: 500,
                color: '#ffffff',
                whiteSpace: 'nowrap',
                textAlign: 'center',
            ...
            <TableCell style={getStickyShotColumnStyle('group_2_name', { backgroundColor: 'rgba(255,255,255,0.07)' })} />
            <TableCell style={getStickyShotColumnStyle('group_3_name', { backgroundColor: 'rgba(255,255,255,0.07)' })} />
