...
from .userRole import RoleManager
...
class MainWindow(QMainWindow, Ui_MainWindow):
    def __init__(
        ...
        # debug extra button  delete this after testing
        # self._extraButton = QPushButton(' Extra')
        # self._extraButton.setMinimumWidth(120)
        # self.rootButtonHLayout.addWidget(self._extraButton)
    ...
    def _manageColumns(self):
        cols = [
            ...
            and col.key() not in ('name', 'thumbnail')
        ]  # noqa: E501
    ...
    def importCsv(self) -> None:
        ...
        try:
            ...
            with open(filePath, 'r', newline='', encoding='utf-8-sig') as f:
                ...
                displayColumns = [h for h in csvHeaders if h in validKeys and h != 'name']
